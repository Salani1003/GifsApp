// To parse this data:
//
//   import { Convert, SearchGIF } from "./file";
//
//   const searchGIF = Convert.toSearchGIF(json);
//
...
export class Convert {
  public static toSearchGIF(json: string): SearchGIF {
    return cast(JSON.parse(json), r('SearchGIF'));
  }

  public static searchGIFToJson(value: SearchGIF): string {
    return JSON.stringify(uncast(value, r('SearchGIF')), null, 2);
  }
}
